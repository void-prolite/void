          ...
          <ScrollReveal direction="up" delay={0.1}>
            <div className="bg-zinc-50 border border-zinc-200 rounded-[2rem] p-8 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.03)] space-y-10 leading-relaxed text-sm md:text-base font-medium">
              ...
              <div className="border-t border-zinc-200 pt-8">
                ...
                <div className="space-y-4">
                  <p className="text-zinc-600">All design systems, code, layouts, visual assets, copy, and branding on this website are the exclusive intellectual property of Void. No part of this site may be reproduced, distributed, or used in any form without prior written permission from Void.</p>
                </div>
              </div>
              ...
              <div className="border-t border-zinc-200 pt-8">
                ...
                <div className="space-y-4">
                  <p className="text-zinc-600">All intellectual property rights in final deliverables (including design files and compiled code) transfer to the client only upon receipt of full and final payment. Until that point, all work-in-progress materials remain the property of Void.</p><p className="text-zinc-600">The following are explicitly excluded from IP transfer and remain the property of Void regardless of payment status:</p><ul className="list-disc list-outside ml-5 text-zinc-600 space-y-2 mt-4"><li className="text-zinc-600">Proprietary frameworks, utility libraries, or reusable components developed independently by Void</li><li className="text-zinc-600">Internal tooling, processes, or scaffolding used in delivery</li></ul><p className="text-zinc-600">Void retains the right to display final deliverables in its portfolio and marketing materials unless the client submits a written opt-out request within 14 days of project completion.</p>
                </div>
              </div>
              ...
              <div className="border-t border-zinc-200 pt-8">
                ...
                <div className="space-y-4">
                  <p className="text-zinc-600">You agree not to use this website or any Void service to:</p><ul className="list-disc list-outside ml-5 text-zinc-600 space-y-2 mt-4"><li className="text-zinc-600">Submit false, misleading, or fraudulent information</li><li className="text-zinc-600">Attempt any form of injection, exploit, or disruption of site infrastructure</li><li className="text-zinc-600">Engage in spam, unsolicited communications, or abusive conduct toward Void personnel</li><li className="text-zinc-600">Violate any applicable local, national, or international law or regulation</li></ul>
                </div>
              </div>
              ...
              <div className="border-t border-zinc-200 pt-8">
                ...
                <div className="space-y-4">
                  <p className="text-zinc-600">Void shall not be liable for any delay or failure in performance resulting from circumstances beyond our reasonable control, including but not limited to illness, platform or infrastructure outages, acts of government, natural disasters, or internet service disruptions. In such cases, we will notify you promptly and make reasonable efforts to resume work as soon as practicable.</p>
                </div>
              </div>
              ...
              <div className="border-t border-zinc-200 pt-8">
                ...
                <div className="space-y-4">
                  <p className="text-zinc-600">This website and all associated services are provided on an "as-is" basis without warranties of any kind, express or implied. Void makes no guarantee of 100% rendering fidelity across all browsers, devices, or third-party platforms. We do not warrant that the site will be available without interruption or free from error at all times.</p>
                </div>
              </div>
