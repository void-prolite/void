export default function Loading() {
  return (
    <div className="min-h-screen bg-transparent px-6 py-24 flex flex-col gap-12">
      <div className="animate-pulse flex space-x-4 max-w-7xl mx-auto w-full">
        <div className="flex-1 space-y-6 py-1">
          ...
          <div className="space-y-3">
            ...
            <div className="h-64 bg-zinc-200 rounded mt-12"></div>
            <div className="h-64 bg-zinc-200 rounded mt-6"></div>
          </div>
        </div>
      </div>
    </div>
