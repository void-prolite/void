...
export default function Hero({ }: HeroProps) {
  ...
  return (
    ...
    >
      {/* Background Parallax */}
      <motion.div style={{ y: isMobile ? 0 : bgY }} className="absolute inset-0 pointer-events-none select-none z-0 bg-transparent" />
      ...
      >
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-semibold leading-[1.15] tracking-[-0.03em] mb-8 select-none text-ink">
          <motion.span
            ...
            animate="visible"
            variants={{
              hidden: { clipPath: isMobile ? "none" : "inset(0 100% 0 0)", opacity: 0, y: isMobile ? 0 : 25 },
              visible: {
                clipPath: isMobile ? "none" : "inset(0 0% 0 0)",
                opacity: 1,
                y: 0,
                transition: { duration: isMobile ? 0.6 : 1.3, delay: isMobile ? 0.08 : 0.15, ease: [0.16, 1, 0.3, 1] }
              }
            }}
          ...
          <motion.span
            ...
            variants={{
              ...
              visible: {
                ...
                opacity: 1,
                y: 0,
                transition: { duration: isMobile ? 0.6 : 1.3, delay: isMobile ? 0.18 : 0.38, ease: [0.16, 1, 0.3, 1] }
              }
            }}
